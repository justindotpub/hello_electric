...
config :hello_electric, HelloElectricWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "xnnIm8ePSKzVIbif92DyDwITlGqk+ki8Ko3c85TH/PwOkrl/DEVccm2QpuJ8ph2T",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:hello_electric, ~w(--sourcemap=inline --watch)]}
  ]
...
config :hello_electric, dev_routes: true
